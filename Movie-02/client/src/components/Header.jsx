    ...
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      <div className="text-center mt-20 mb-8">
        ...
        <h1 className="text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-700">
          Your own <span className="text-primary">movie</span> <br /> Space.
        </h1>

        <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs">
          This is your place to explore films, discover stories, and learn
          everything about them. Whether it’s a quick summary or a deep dive,
          your movie journey starts right here.
        </p>
